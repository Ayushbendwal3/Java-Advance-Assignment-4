...
<div>
    <fieldset>
        ...
        <form method="post" action="flightSearch">
            ...
            <br><br>
            <label>Flight Date <input name="flightDate" type="date" required></label><form:errors
                path="flightdetails.flightDate"/>
            <br><br>
            <label>Flight Class <input name="flightClass" required></label><form:errors
                path="flightdetails.flightClass"/>
            <br><br>
